 ...
 *         &lt;element name="variables" type="{http://www.processmaker.com}variableListNameStruct" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "getVariablesNamesResponse")
public class GetVariablesNamesResponse {
    ...
    protected List<VariableListNameStruct> variables;
     ...
     * {@link VariableListNameStruct }
     * 
     * 
     */
    public List<VariableListNameStruct> getVariables() {
        if (variables == null) {
            variables = new ArrayList<VariableListNameStruct>();
        }
