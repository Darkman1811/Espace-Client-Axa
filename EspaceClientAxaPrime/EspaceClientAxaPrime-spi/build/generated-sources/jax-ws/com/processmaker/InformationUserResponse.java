 ...
 *         &lt;element name="info" type="{http://www.processmaker.com}informationUserStruct" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "informationUserResponse")
public class InformationUserResponse {
    ...
    protected List<InformationUserStruct> info;
     ...
     * {@link InformationUserStruct }
     * 
     * 
     */
    public List<InformationUserStruct> getInfo() {
        if (info == null) {
            info = new ArrayList<InformationUserStruct>();
        }
        return this.info;
    }
