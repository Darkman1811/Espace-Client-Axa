 ...
 *         &lt;element name="routing" type="{http://www.processmaker.com}routeListStruct" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "routeCaseResponse")
public class RouteCaseResponse {
    ...
    protected List<RouteListStruct> routing;
     ...
     * {@link RouteListStruct }
     * 
     * 
     */
    public List<RouteListStruct> getRouting() {
        if (routing == null) {
            routing = new ArrayList<RouteListStruct>();
        }
        return this.routing;
    }
