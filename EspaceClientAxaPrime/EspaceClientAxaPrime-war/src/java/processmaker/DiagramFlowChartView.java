...
@RequestScoped
public class DiagramFlowChartView {
    ...
    public void init() {
        ...
        Element start = new Element("Declaration de sinistre", "6em", "6em");
        start.addEndPoint(new BlankEndPoint(EndPointAnchor.BOTTOM));
        start.addEndPoint(new BlankEndPoint(EndPointAnchor.LEFT));
         
        Element trouble = new Element("Do ", "20em", "18em");
        ...
        trouble.setStyleClass("ui-diagram-connector");
