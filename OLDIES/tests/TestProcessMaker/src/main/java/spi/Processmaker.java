 ...
 * @author darkman
 */
@WebService(serviceName = "ProcessMakerService", portName = "ProcessMakerServiceSoap", endpointInterface = "com.processmaker.ProcessMakerServiceSoap", targetNamespace = "http://www.processmaker.com", wsdlLocation = "META-INF/wsdl/172.17.0.3/sysworkflow/en/neoclassic/services/wsdl2.wsdl")
